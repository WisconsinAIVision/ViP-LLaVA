...
# CKPT="llava-v1.5-13b"
CKPT=$model_name_replace # "llava-v1.5-13b"

for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_vqa_loader \
        --model-path ./checkpoints/$model_name_replace \
        --question-file ./playground/data/eval/seed_bench/llava-seed-bench-imgonly.jsonl \
...
python scripts/convert_seed_for_submission.py \
    --annotation-file ./playground/data/eval/seed_bench/SEED-Bench-imgonly.json \
